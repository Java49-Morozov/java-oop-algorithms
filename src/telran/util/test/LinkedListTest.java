...
class LinkedListTest {
	...
	void testIndexOf() {
		...
		assertEquals(3, list.indexOf(50));
		assertEquals(5, list.indexOf(30));
		assertEquals(-1, list.indexOf(456));
		list.add(3,120);
		assertEquals(3, list.indexOf(120));		
		list.add(6,7);
	...
	void testLastIndexOf() {
		...
		assertEquals(3, list.lastIndexOf(50));
		assertEquals(5, list.lastIndexOf(30));
		assertEquals(-1, list.lastIndexOf(456));
		list.add(3,120);
		assertEquals(3, list.lastIndexOf(120));		
		list.add(6,7);
...
//			});
	...
	void testIndexOfPredicate()  {
		...
		assertEquals(2, list.indexOf(a -> a == 7));
		list.add(-17);
		assertEquals(-1, list.indexOf(a -> a % 2 != 0 && a > 7));
		list.add(1,7);
		assertEquals(1, list.indexOf(a -> a == 7));
	}
	@Test
